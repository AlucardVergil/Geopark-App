...
public class LanguageSwitch : MonoBehaviour
{
    ...
    public void ChangeTextsLanguage(bool  isEnglish)
    {
        ...
        geoparkInfoTitle.text = (isEnglish ? "About Geopark Grevena - Kozani" : "Σχετικά με το Γεοπάρκο Γρεβενών - Κοζάνης");
        ...
        servicesInfoTitle.text = (isEnglish ? "Geopark & Services Info" : "Πληροφορίες Υπηρεσιών Γεοπάρκου");
        ...
        startingPanelTitle.text = (isEnglish ? "Geopark Grevena - Kozani" : "Γεοπάρκο Γρεβενών - Κοζάνης");
